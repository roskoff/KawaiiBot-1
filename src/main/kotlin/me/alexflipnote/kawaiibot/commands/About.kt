...
class About : ICommand {
    override fun run(ctx: CommandContext) {
        ctx.sendEmbed {
            ...
            addField("Developers", "AlexFlipnote, devoxin, Yvan, Aurieh, stupid cat & william | Modified for NieR: Automata by hitoccchi", false)
            addField("Library", "JDA ${JDAInfo.VERSION}", true)
            addField("My Server!", "sponsoredbydrakengard.com", true)
